...
const CreateMeeting = () => {
    ...
    if (isEditMode) {
      const fetchMeeting = async () => {
        try {
          ...
          setFormData({
            organizationId: m.organizedBy?._id || m.organizedBy || "",
            title: m.agenda || "",
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!formData.organizationId) return setError("Please select an organization.");
    ...
    try {
      ...
      // Build attendees array: one of them will have isScriber=true
  ...
  return (
    <div className="min-h-screen bg-sidebar/10">
      <AttendeePicker 
        ...
        title="Invite Platform Attendees"
        singleSelect={false}
      />
      ...
      <div className="p-4 md:p-8 pb-0 mt-4 lg:mt-0">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          <div className="flex items-center gap-2 md:gap-4 text-[10px] md:text-xs font-bold text-slate-400 uppercase tracking-[0.2em] overflow-x-auto whitespace-nowrap pb-2 md:pb-0">
            ...
            <span className="text-charcoal">Meeting Oversight</span>
            <ChevronRight size={12} className="shrink-0" />
            <span className="text-primary font-bold">Schedule Session</span>
          </div>
        ...
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-2xl md:text-3xl font-bold text-charcoal tracking-tight">
              {isEditMode ? "Modify Platform Meeting" : "Schedule New Platform Meeting"}
            </h1>
              ...
              <div className="p-6 md:p-8 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 text-sm border border-border rounded-lg bg-sidebar/20 text-charcoal focus:outline-none focus:ring-1 focus:ring-primary/30 font-medium appearance-none"
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="e.g. Quarterly Strategic Infrastructure Alignment"
                    className="w-full px-4 py-3 text-sm border border-border rounded-lg bg-sidebar/20 text-charcoal focus:outline-none focus:ring-1 focus:ring-primary/30 font-medium"
                  />
                </div>
